...
<!--<div id="rightcolumn">
    <h4>MyStuff File Upload</h4>
</div>--><!--end right column-->
<div id="body">
    <h1>MyStuff Backup File Upload</h1>
    <p>Welcome to MyStuff Backup File Upload<br><br>
    Please use the following input boxes to upload up to five (5) files.</p>
    <div>
        <form method="post" action="edu.byu.isys413.actions.fileUpload.action" enctype="multipart/form-data">
